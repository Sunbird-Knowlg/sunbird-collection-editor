export const mockData = {
    ...
    listData: ['No Hate speech, Abuse, Violence, Profanity',
        ...
        'Correct Board, Grade, Subject, Medium', 'Appropriate tags such as Resource Type, Concepts',
        'Relevant Keywords', 'Content plays correctly', 'Can see the content clearly on Desktop and App',
        'Audio (if any) is clear and easy to understand',
        'No Spelling mistakes in the text', 'Language is simple to understand'],
    checkedData: {
